...
const benefitThree = {
  ...
  bullets: [
    {
      title: "Концентрация",
      desc: "Улучшите навык концентрации внимания, который полезен не только в медитации, а также в учебе, работе и бизнесе",
    ...
    },
    {
      ...
      desc: "Плучите поддержку единомышленников и обмен опытом",
