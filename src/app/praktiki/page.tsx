        ...
        <Container>
          ...
          {/* <div className="flex justify-center">
            <div className="mt-32 max-w-5xl flex flex-col lg:flex-row items-center lg:items-start gap-5">
              <div className="flex flex-col items-start justify-start">
                <h2 className="w-full text-center text-sm font-semibold tracking-wider text-indigo-600 uppercase">медитация сиддхов</h2>
                <h2 className="w-full text-4xl text-center font-semibold">Детали мероприятия</h2>
                <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-5 xl:gap-10 lg:grid-cols-2">
